  ...
  return (
    <section className="w-full py-20 bg-gradient-to-br from-[#232946] to-[#181c2a] flex flex-col items-center justify-center">
      <div className="max-w-2xl mx-auto text-center px-4">
        <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-6 drop-shadow-lg">Ready to Transform Your Space?</h2>
        <p className="text-lg text-[#f6d365] mb-10 max-w-xl mx-auto">Join hundreds of organizations that trust Pathix for their mapping needs. Get started with a free consultation today.</p>
